<!DOCTYPE html>
<head>
<title>Quản trị website</title>
...
<link rel="stylesheet" type="text/css" href="{{ asset('public/admin/css/jquery.dataTables.css') }}">
<!-- calendar -->
...
<!--CKEditor-->
<script src="{{ asset('/public/vendors/backend/editor/ckeditor/ckeditor.js') }}"></script>
<script src="{{ asset('/public/vendors/backend/editor/ckfinder/ckfinder.js') }}"></script>
@yield('css')
</head>
<body>
<section id="container">
    ...
    <section id="main-content">
		<section class="wrapper">
			...
			<div class="col-lg-12 form_content">
				@yield('content')
			</div>
