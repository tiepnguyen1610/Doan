    ...
    <form action="{{ route('roles.update',['id'=>$role->id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-lg-12" style="padding-bottom:10px">
            <div class="form-group">
                ...
                <input type="text" name="txtRole" class="form-control" value="{{ $role->role_name }}" placeholder= "Nhập tên vai trò.." />
            </div>
            <div class="form-group">
                <label>Mô tả</label>
                <textarea name="txtDescription" rows="2" class="form-control" placeholder= "Mô tả vai trò" >{{$role->display_name}}
                </textarea>
            </div>  
        </div>
